...
<div class="row">
    <div class="col-md-4">
        <div class="card shadow-sm">
            <img src="http://127.0.0.1:8000/assets/images/img-1.jpg" class="card-img-top" alt="Blog Image">
            <div class="card-body">
    ...
    <div class="col-md-4">
        <div class="card shadow-sm">
            <img src="http://127.0.0.1:8000/assets/images/img-2.jpg" class="card-img-top" alt="Blog Image">
            <div class="card-body">
    ...
    <div class="col-md-4">
        <div class="card shadow-sm">
            <img src="http://127.0.0.1:8000/assets/images/img-3.jpg" class="card-img-top" alt="Blog Image">
            <div class="card-body">
