<div class="collapse navbar-collapse  w-auto " id="sidenav-collapse-main">
    <ul class="navbar-nav">
      ...
      <li class="nav-item">
        <a class="nav-link  {{ request()->routeIs('admin.home_page') ? 'active' : '' }}" href="{{ route('admin.home_page') }}">
          <div class="icon icon-shape icon-sm shadow border-radius-md bg-white text-center me-2 d-flex align-items-center justify-content-center">
      ...
      <li class="nav-item">
        <a class="nav-link  {{ request()->routeIs('admin.blogs.index') ? 'active' : '' }}" href="{{ route('admin.blogs.index') }}">
          <div class="icon icon-shape icon-sm shadow border-radius-md bg-white text-center me-2 d-flex align-items-center justify-content-center">
      ...
      <li class="nav-item">
        <a class="nav-link {{ request()->routeIs('admin.orders.index') ? 'active' : '' }}" href="{{ route('admin.orders.index') }}">
          <div class="icon icon-shape icon-sm shadow border-radius-md bg-white text-center me-2 d-flex align-items-center justify-content-center">
            <!-- Icon for Orders (Clipboard/Document style) -->
            <svg width="12px" height="12px" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
              <path d="M8 2H16C16.5523 2 17 2.44772 17 3V5H19C19.5523 5 20 5.44772 20 6V20C20 21.1046 19.1046 22 18 22H6C4.89543 22 4 21.1046 4 20V6C4 5.44772 4.44772 5 5 5H7V3C7 2.44772 7.44772 2 8 2Z" stroke="#5e72e4" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"/>
              <path d="M9 12H15" stroke="#5e72e4" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"/>
              <path d="M9 16H15" stroke="#5e72e4" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"/>
              <path d="M9 8H15" stroke="#5e72e4" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"/>
            </svg>
          </div>
    ...
    <li class="nav-item">
      <a class="nav-link {{ request()->routeIs('admin.social-links.index') ? 'active' : '' }}" href="{{ route('admin.social-links.index') }}">
        <div class="icon icon-shape icon-sm shadow border-radius-md bg-white text-center me-2 d-flex align-items-center justify-content-center">
          <!-- Facebook Icon SVG -->
    ...
    <li class="nav-item">
      <a class="nav-link {{ request()->routeIs('admin.msgs.index') ? 'active' : '' }}" href="{{ route('admin.msgs.index') }}">
        <div class="icon icon-shape icon-sm shadow border-radius-md bg-white text-center me-2 d-flex align-items-center justify-content-center">
          <!-- Message Icon SVG -->
